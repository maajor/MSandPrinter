...
class Stepper {
  ...
  private:
    ...
    static long counter_X, counter_Y, counter_Z, counter_E, counter_W, counter_S;
  ...
  public:
    ...
    //
    static void set_position(const long &a, const long &b, const long &c, const long &e , const long &w , const long &s);
