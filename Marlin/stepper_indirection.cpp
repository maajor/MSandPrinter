...
//
  ...
  #endif
  #if ENABLED(W_IS_TMC)
    TMC26XStepper stepperW(200, W_ENABLE_PIN, W_STEP_PIN, W_DIR_PIN, W_MAX_CURRENT, W_SENSE_RESISTOR);
  #endif
  #if ENABLED(S_IS_TMC)
    TMC26XStepper stepperS(200, S_ENABLE_PIN, S_STEP_PIN, S_DIR_PIN, S_MAX_CURRENT, S_SENSE_RESISTOR);
  #endif
...
//
  ...
  #endif
  #if ENABLED(W_IS_TMC2130)
    Trinamic_TMC2130 stepperW(W_CS_PIN);
  #endif
  #if ENABLED(S_IS_TMC2130)
    Trinamic_TMC2130 stepperS(S_CS_PIN);
  #endif
...
//
  ...
  #endif
  #if ENABLED(W_IS_L6470)
    L6470 stepperW(W_ENABLE_PIN);
  #endif
  #if ENABLED(S_IS_L6470)
    L6470 stepperS(S_ENABLE_PIN);
  #endif
