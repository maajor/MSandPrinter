...
const char axis_codes[NUM_AXIS] = {'X', 'Y', 'Z', 'E', 'W', 'S'};
...
inline void sync_plan_position() {
  ...
  #endif
  planner.set_position_mm(current_position[X_AXIS], current_position[Y_AXIS], current_position[Z_AXIS], current_position[E_AXIS],current_position[W_AXIS],current_position[S_AXIS]);
}
...
inline void line_to_current_position() {
  planner.buffer_line(current_position[X_AXIS], current_position[Y_AXIS], current_position[Z_AXIS], current_position[E_AXIS], current_position[W_AXIS],current_position[S_AXIS],feedrate_mm_s, active_extruder);
}
...
inline void line_to_destination(float fr_mm_s) {
  planner.buffer_line(destination[X_AXIS], destination[Y_AXIS], destination[Z_AXIS], destination[E_AXIS], destination[W_AXIS], destination[S_AXIS],fr_mm_s, active_extruder);
}
...
static void do_homing_move(const AxisEnum axis, float distance, float fr_mm_s=0.0) {
  ...
  current_position[axis] = 0;
    ...
    sync_plan_position();
    current_position[axis] = distance;
    planner.buffer_line(current_position[X_AXIS], current_position[Y_AXIS], current_position[Z_AXIS], current_position[E_AXIS], current_position[W_AXIS],current_position[S_AXIS],fr_mm_s ? fr_mm_s : homing_feedrate_mm_s[axis], active_extruder);
  #endif
...
static void report_current_position() {
  ...
  SERIAL_PROTOCOL(current_position[S_AXIS]);
